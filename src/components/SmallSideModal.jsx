...
function SmallSideModal() {
  ...
  return (
    <main className="fixed inset-0 flex left-[29rem] bottom-[140px] transition-all  delay-100 w-[126px] h-[70px] shadow-md shadow-primary-400 bg-primary-400/50 m-auto z-[100] ">
